...
histcontent = Replace(rs("content"),"'","''")
histrecord = recordno & "," & rs("boxid") & "," & rs("retention") & "," & rs("status") & "," & rs("disposition") & "," & rs("entrydate") & "," & rs("updatedate") & "," & rs("recorddate") & "," & rs("reviewdate") & "," & rs("deletedate") & "," & histcontent
